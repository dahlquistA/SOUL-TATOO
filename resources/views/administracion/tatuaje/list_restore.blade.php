        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table id="listadoTatuajes" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                               ...
                               <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                                <button type="button" class="btn paddBto" id="btoRestore_{{$tatuaje->id}}" onclick="activarTatuaje({{$tatuaje->id}})" >
...
@section('scripts')
    ...
    function activarTatuaje(tatuajeId){
        $.ajax({
                type: "POST",
                dataType: "json",
                url: '/tatuaje/restore',
                ...
                success: function(data){
                    if(data.status===200){
                        $(`#btoRestore_${tatuajeId}`).css('display','none');
                        toastr.success("Tatuaje Activado");
                    }else{
                        $(`#btoRestore_${tatuajeId}`).css('display','inline-block');
                        toastr.error("Tatuaje No Activado");
                    }
                }
            });
    }
